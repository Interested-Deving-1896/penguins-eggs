...
### 3. Testare la ISO
Le ISO prodotte vengono salvate per impostazione predefinita all'interno della cartella `/home/eggs/`. L'utente live standard is `live` con password `evolution`.
